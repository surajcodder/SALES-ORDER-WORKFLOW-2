		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#SalesOrderFlowworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SalesOrderFlowworkflowuimodule-display": {
								"semanticObject": "SalesOrderFlowworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=SalesOrderFlow.workflowuimodule",
									"url": sap.ui.require.toUrl("SalesOrderFlow/workflowuimodule")
								}
							}
						}
					}
